...
/* EdCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EdCash"
#define QAPP_ORG_DOMAIN "edcash.io"
#define QAPP_APP_NAME_DEFAULT "EdCash-Qt"
#define QAPP_APP_NAME_TESTNET "EdCash-Qt-testnet"
