...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EdCash features */
        {"edcash", "masternode", &masternode, true, true, false},
        {"edcash", "listmasternodes", &listmasternodes, true, true, false},
        {"edcash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"edcash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"edcash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"edcash", "masternodedebug", &masternodedebug, true, true, false},
        {"edcash", "startmasternode", &startmasternode, true, true, false},
        {"edcash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"edcash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"edcash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"edcash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"edcash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"edcash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"edcash", "mnbudget", &mnbudget, true, true, false},
        {"edcash", "preparebudget", &preparebudget, true, true, false},
        {"edcash", "submitbudget", &submitbudget, true, true, false},
        {"edcash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"edcash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"edcash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"edcash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"edcash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"edcash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"edcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"edcash", "checkbudgets", &checkbudgets, true, true, false},
        {"edcash", "mnsync", &mnsync, true, true, false},
        {"edcash", "spork", &spork, true, true, false},
        {"edcash", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"edcash", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"edcash", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"edcash", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"edcash", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"edcash", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> edcash-cli " + methodname + " " + args + "\n";
}
