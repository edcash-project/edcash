...
#if defined(NDEBUG)
#error "EdCash cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uedc) are considered zero fee (for relaying and mining)
