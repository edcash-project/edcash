...
In order to support loading of multiple wallets in edcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is edcash.cpp.
...
Changes to edcash.cpp
----------------------
edcash.cpp is the entry point into edcash-qt, and as such, will require some minor modifications to provide hooks for
