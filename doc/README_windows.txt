...
Intro
-----
EdCash (EDC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. EdCash utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run edcash-qt.exe.

EdCash Core is the original EdCash client and it builds the backbone of the network.
However, it downloads and stores the entire history of EdCash transactions;
