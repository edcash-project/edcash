...
#   c) node1 mines 32 blocks, so now node 0 has 500000EDC, node 1 has 4250EDC, node2 has none.
#   d) node0 sends 601 EDC to node2, in two transactions (301 EDC, then 300 EDC).
